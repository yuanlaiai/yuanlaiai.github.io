...
var siteData = {
  ...
  "topic": "🌟 <strong>Agent 视野拓展：从 CLI 到全网</strong> —— 今天的榜单呈现了一个有趣趋势：Agent 正在从「本地工具」走向「网络原生」。Superpowers 重返热榜（+1,008），CopilotKit（+613）为 Agent 赋予前端 UI，Agent-Reach（+148）更是让 Agent 直达 B 站和小红书。同时微软的 VibeVoice（+219）将语音 AI 能力开源。Agent 的感知边界正在扩展——能看网页、能听语音、能做 UI。",
  "days": [
    {
      "date": "2026-06-06",
      "label": "今天",
