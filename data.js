...
var siteData = {
  ...
  "topic": "🔥 <strong>连续第三天：Agent 基础设施全面爆发</strong> —— Headroom 连续三天霸榜（+3,142），从 5.4K→12.4K★ 只用三天。Hermes Agent 连续第二天上榜（+1,913），ECC 第四次入榜（+1,750），Agent 基础设施的持续热度标志着行业从「做 Agent」进入「做好 Agent」的阶段。同时 Open Notebook（25K★）和 Open-LLM-VTuber（9.6K★）也展现了 AI 消费级应用的新方向。",
  "days": [
    {
      "date": "2026-06-05",
      "label": "今天",
