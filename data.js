...
var siteData = {
  ...
  "topic": "📄 <strong>文档解析赛道双雄争霸</strong> —— 今天一个有趣的现象：microsoft/markitdown（+1,984）和 opendataloader-pdf（+570）同时上榜，一个将各种文档转 Markdown，一个专攻 PDF 解析。同时 Hermes Agent 本体首次上榜（+1,735），展示开源 Agent 的生态力量。而 headroom 连续两天霸榜榜首（+3,530），Token 压缩已经成为 Agent 效率的标配。",
  "days": [
    {
      "date": "2026-06-04",
      "label": "今天",
