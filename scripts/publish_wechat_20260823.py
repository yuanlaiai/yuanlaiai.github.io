...
def gen_cover():
    ...
    draw.text((60, 150), "AI 进校园的代价", fill='#ffffff', font=tf)
    draw.text((60, 250), "作业 +18%，考试 -20%", fill='#ff8c42', font=sf)
    draw.rectangle([60, 340, 260, 343], fill='#ff8c42')
    draw.text((60, 370), "猿来AI · 2026-08-23 深度解读", fill='#8a8a9a', font=lf)
    img.save(COVER)
