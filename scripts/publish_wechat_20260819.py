...
COVER = '/tmp/cover-agent-memory.png'
...
def gen_cover():
    ...
    draw.text((60, 150), "OpenViking × Agent 记忆", fill='#ffffff', font=tf)
    draw.text((60, 250), "字节下场，军备竞赛换战场", fill='#ff8c42', font=sf)
    draw.rectangle([60, 340, 260, 343], fill='#ff8c42')
    draw.text((60, 370), "猿来AI · 2026-08-19 深度解读", fill='#8a8a9a', font=lf)
    img.save(COVER)
