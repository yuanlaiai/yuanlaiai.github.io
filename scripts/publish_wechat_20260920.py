#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Publish 2026-09-20 AGENTS.md article to WeChat draft: cover gen + draft/add + fetch url + backfill"""
...
def gen_cover():
    ...
    draw.text((60, 128), "Shopify 威胁封杀", fill='#ffffff', font=tf)
    draw.text((60, 208), "Claude Code", fill='#ff8c42', font=tf)
    draw.text((60, 300), "一份 MD 文件的默认权之争", fill='#ffffff', font=sf)
    draw.rectangle([60, 388, 260, 391], fill='#ff8c42')
    draw.text((60, 412), "猿来AI · 2026-09-20 深度解读", fill='#8a8a9a', font=lf)
    img.save(COVER)
