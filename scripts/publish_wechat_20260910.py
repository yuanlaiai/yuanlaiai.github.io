#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Publish 2026-09-10 DeepSeek V4.1-Flash article to WeChat draft: cover gen + draft/add + fetch url + backfill"""
...
COVER = '/tmp/cover-deepseek-v41.png'
...
def gen_cover():
    ...
    tf = font(56); sf = font(42); lf = font(22)
    draw.rectangle([60, 78, 160, 82], fill='#ff8c42')
    draw.rectangle([60, 93, 130, 96], fill='#ff8c42')
    draw.text((60, 130), "552B 模型只激活 8B 参数", fill='#ffffff', font=tf)
    draw.text((60, 225), "价格是 Opus-5 的 1/33", fill='#ff8c42', font=sf)
    draw.text((60, 310), "DeepSeek 改写 Agent 成本账", fill='#ffffff', font=sf)
    draw.rectangle([60, 392, 260, 395], fill='#ff8c42')
    draw.text((60, 415), "猿来AI · 2026-09-10 深度解读", fill='#8a8a9a', font=lf)
    img.save(COVER)
