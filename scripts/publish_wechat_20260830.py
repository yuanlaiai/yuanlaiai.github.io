...
def gen_cover():
    ...
    draw.text((60, 150), "OpenAI × Cursor 断供", fill='#ffffff', font=tf)
    draw.text((60, 250), "Musk vs Altman 生态战", fill='#ff8c42', font=sf)
    draw.rectangle([60, 340, 260, 343], fill='#ff8c42')
    draw.text((60, 370), "猿来AI · 2026-08-30 深度解读", fill='#8a8a9a', font=lf)
    img.save(COVER)
