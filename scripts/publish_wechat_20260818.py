...
COVER = '/tmp/cover-apple-alibaba-qwen.png'
...
def gen_cover():
    ...
    draw.text((60, 150), "苹果 × 阿里", fill='#ffffff', font=tf)
    draw.text((60, 250), "「中国特供」大模型的攻防棋局", fill='#ff8c42', font=sf)
    draw.rectangle([60, 340, 260, 343], fill='#ff8c42')
    draw.text((60, 370), "猿来AI · 2026-08-18 深度解读", fill='#8a8a9a', font=lf)
    img.save(COVER)
